...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        LoanStatusTest.register(runner);
        BookTest.register(runner);
        MemberTest.register(runner);
        LoanRecordTest.register(runner);
        LibraryTest.register(runner);
        SearchTest.register(runner);
