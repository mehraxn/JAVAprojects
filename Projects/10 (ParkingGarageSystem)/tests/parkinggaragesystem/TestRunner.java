 ...
 * summary, then exits 0 only when every case passed.
 */
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        VehicleTest.register(runner);
        ParkingSpotTest.register(runner);
        ParkingLevelTest.register(runner);
        ParkingReceiptTest.register(runner);
        FeeCalculationTest.register(runner);
        GarageTest.register(runner);
