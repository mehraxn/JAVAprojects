...
public final class Assert {
    ...
    /** Compares money values numerically with compareTo, so 5.0 equals 5.00. */
    public void assertBigDecimalEquals(BigDecimal expected, BigDecimal actual, String message) {
        check(expected != null && actual != null && expected.compareTo(actual) == 0,
                message + " -- expected <" + expected + "> but was <" + actual + ">");
    }
