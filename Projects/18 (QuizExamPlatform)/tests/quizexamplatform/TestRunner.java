...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        runSuite(t, "QuestionTest", () -> QuestionTest.run(t));
        runSuite(t, "QuizTest", () -> QuizTest.run(t));
        runSuite(t, "QuizAttemptTest", () -> QuizAttemptTest.run(t));
        runSuite(t, "QuizResultTest", () -> QuizResultTest.run(t));
        runSuite(t, "ScoreBoardTest", () -> ScoreBoardTest.run(t));
