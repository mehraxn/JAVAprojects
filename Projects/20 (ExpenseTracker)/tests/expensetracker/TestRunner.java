...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        runSuite(t, "ExpenseTest", () -> ExpenseTest.run(t));
        runSuite(t, "ExpenseServiceTest", () -> ExpenseServiceTest.run(t));
        runSuite(t, "CsvExpenseStoreTest", () -> CsvExpenseStoreTest.run(t));
