...
public final class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        runSuite(t, "TaskTest", () -> TaskTest.run(t));
        runSuite(t, "InMemoryTaskRepositoryTest", () -> InMemoryTaskRepositoryTest.run(t));
        runSuite(t, "TaskServiceTest", () -> TaskServiceTest.run(t));
        runSuite(t, "DatabaseConnectionTest", () -> DatabaseConnectionTest.run(t));
        runSuite(t, "JdbcRepositoryStaticTest", () -> JdbcRepositoryStaticTest.run(t));
