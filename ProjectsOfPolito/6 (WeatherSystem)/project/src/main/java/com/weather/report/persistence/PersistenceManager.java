...
public class PersistenceManager {
  ...
  public static void setTestMode() {
    // Close any existing factory.
    // Since 'hibernate.hbm2ddl.auto' is 'create-drop' in the test PU, closing the
  ...
  private static synchronized EntityManagerFactory getCurrentFactory() {
    if (factory == null || !factory.isOpen()) {
      // When this is created, Hibernate sees create-drop and automatically creates
      // new empty tables.
